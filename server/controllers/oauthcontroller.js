...
const OAuthTokensModel = require('../database/models').OAuthTokens;
const OAuthClientsModel = require('../database/models').OAuthClients;
const OAuthUsersModel = require('../database/models').OAuthUsers;
